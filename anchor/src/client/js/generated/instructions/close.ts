...
export type CloseInstruction<
  ...
  TAccountCodamaescrow extends string | AccountMeta<string> = string,
  ...
  InstructionWithAccounts<
    [
      TAccountPayer extends string
        ...
        : TAccountPayer,
      TAccountCodamaescrow extends string
        ? WritableAccount<TAccountCodamaescrow>
        : TAccountCodamaescrow,
      ...TRemainingAccounts,
    ]
  >;
...
export type CloseInput<
  ...
  TAccountCodamaescrow extends string = string,
> = {
  payer: TransactionSigner<TAccountPayer>;
  codamaescrow: Address<TAccountCodamaescrow>;
};
...
>(
  input: CloseInput<TAccountPayer, TAccountCodamaescrow>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountCodamaescrow> {
  // Program address.
  ...
  const originalAccounts = {
    ...
    codamaescrow: { value: input.codamaescrow ?? null, isWritable: true },
  };
  ...
  return Object.freeze({
    accounts: [
      ...
      getAccountMeta(accounts.codamaescrow),
    ],
    data: getCloseInstructionDataEncoder().encode({}),
    programAddress,
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountCodamaescrow>);
}
...
>(
  ...
  return {
    ...
    accounts: { payer: getNextAccount(), codamaescrow: getNextAccount() },
