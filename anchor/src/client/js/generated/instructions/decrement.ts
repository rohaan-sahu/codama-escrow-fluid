...
export type DecrementInput<TAccountCodamaescrow extends string = string> = {
...
>(
  input: DecrementInput<TAccountCodamaescrow>,
  config?: { programAddress?: TProgramAddress }
): DecrementInstruction<TProgramAddress, TAccountCodamaescrow> {
  // Program address.
  ...
  return Object.freeze({
    accounts: [getAccountMeta(accounts.codamaescrow)],
    data: getDecrementInstructionDataEncoder().encode({}),
    programAddress,
  } as DecrementInstruction<TProgramAddress, TAccountCodamaescrow>);
}
...
>(
  ...
  return {
    ...
    accounts: { codamaescrow: getNextAccount() },
